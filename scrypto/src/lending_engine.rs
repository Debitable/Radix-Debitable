use scrypto::prelude::*;
use crate::lending_app::LendingAppComponent;
...
blueprint!{
    ...
    struct LendingEngine{
        ...
        loan_pool: HashMap<ResourceAddress, LendingAppComponent>
    }
    ...
    impl LendingEngine {
       ...
       /// # Returns a new LendingAppComponent component.
       pub fn new_loan_pool(
            ...
            info!("Creating new LendingAppComponent ") ;
            let lending_app: ComponentAddress  = LendingAppComponent::instantiate_pool(
